            ...
            <Grid
                ...
                className="hright">
                    <ul className="headerContact">
                        <li><PhoneAndroidIcon /><a className='fontGrey' href={"tel:"+ phonetrim}>{phone}</a></li>
                ...
                {/* <Hidden smDown> */}
                    ...
                    className="text-right">
                        <Link className="btnStyle btnOutlined btnRadius txtCenter" href={"tel:"+ phonetrim}>Call Us</Link>
                    </Grid>
                {/* </Hidden> */}
            </Grid>
